 ...
 *  at the start (and mirrored at the end before looping). Range: 0–40. */
export const FULL_VIEW_PAUSE = 12; // %

/** Seconds of static full-viewport display before the zoom+pan loop begins. */
export const ANIMATION_START_DELAY = FULL_VIEW_PAUSE / 2; // s

/** Animation duration range in seconds — each card picks a random value in [MIN, MAX]. */
export const DURATION_MIN = 40;
export const DURATION_MAX = 70;
