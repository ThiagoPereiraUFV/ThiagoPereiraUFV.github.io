...
describe("Footer Component", () => {
  ...
  it("should render footer with contact message", () => {
    ...
    const message = screen.getByText("Let's work together");
  ...
  it("should render with correct CSS classes", () => {
    ...
    expect(footer?.className).toContain("tw:scroll-mt-20");
    const innerDiv = footer?.querySelector("div");
    expect(innerDiv?.className).toContain("tw:grid");
    expect(innerDiv?.className).toContain("tw:grid-cols-1");
    expect(innerDiv?.className).toContain("tw:text-center");
  });
